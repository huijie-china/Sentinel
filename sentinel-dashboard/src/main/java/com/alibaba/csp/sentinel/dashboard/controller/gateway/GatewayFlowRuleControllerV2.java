...
import com.alibaba.csp.sentinel.dashboard.rule.gateway.DynamicGatewayRuleProvider;
import com.alibaba.csp.sentinel.dashboard.rule.gateway.DynamicGatewayRulePublisher;
...
public class GatewayFlowRuleControllerV2 {
    ...
    private DynamicGatewayRuleProvider<List<GatewayFlowRuleEntity>> ruleProvider;
    @Autowired
    @Qualifier("gatewayFlowRuleApolloPublisher")
    private DynamicGatewayRulePublisher<List<GatewayFlowRuleEntity>> rulePublisher;

    @Autowired
    private AuthService<HttpServletRequest> authService;

    @GetMapping("/list.json")
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(HttpServletRequest request, String app, String ip, String port) {
    ...
    public Result<GatewayFlowRuleEntity> addFlowRule(HttpServletRequest request, @RequestBody AddFlowRuleReqVo reqVo) {
        ...
        try {
            ...
            logger.error("publish gateway rules error", e);
        }
    ...
    public Result<GatewayFlowRuleEntity> updateFlowRule(HttpServletRequest request, @RequestBody UpdateFlowRuleReqVo reqVo) {
        ...
        try {
            ...
            logger.error("update gateway rules error", e);
        }
