...
app.controller('GatewayApiV2', ['$scope', '$stateParams', 'GatewayApiServiceV2', 'ngDialog', 'MachineService',
    function ($scope, $stateParams, GatewayApiServiceV2, ngDialog, MachineService) {
        ...
        $scope.saveApi = function () {
            ...
            if (!GatewayApiServiceV2.checkApiValid($scope.currentApi, apiNames)) {
                return;
            }
        ...
        function addNewApi(api) {
            GatewayApiServiceV2.newApi(api).success(function (data) {
                if (data.code == 0) {
                    getApis();
        ...
        function saveApi(api, edit) {
            GatewayApiServiceV2.saveApi(api).success(function (data) {
                if (data.code == 0) {
                    getApis();
                    if (edit) {
                        gatewayApiDialog.close();
        ...
        function deleteApi(api) {
            GatewayApiServiceV2.deleteApi(api).success(function (data) {
                if (data.code == 0) {
                    getApis();
                    confirmDialog.close();
                } else {
