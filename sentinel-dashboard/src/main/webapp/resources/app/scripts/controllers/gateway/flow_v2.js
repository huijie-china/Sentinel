...
app.controller('GatewayFlowV2', ['$scope', '$stateParams', 'GatewayFlowServiceV2', 'GatewayApiServiceV2', 'ngDialog', 'MachineService',
    function ($scope, $stateParams, GatewayFlowServiceV2, GatewayApiServiceV2, ngDialog, MachineService) {
        ...
        function getMachineRules() {
            ...
            GatewayFlowServiceV2.queryRules($scope.app, mac[0], mac[1]).success(
                function (data) {
        ...
        $scope.saveRule = function () {
            if (!GatewayFlowServiceV2.checkRuleValid($scope.currentRule)) {
                return;
            }
        ...
        function addNewRule(rule) {
            GatewayFlowServiceV2.newRule(rule).success(function (data) {
                if (data.code == 0) {
                    getMachineRules();
        ...
        function saveRule(rule, edit) {
            GatewayFlowServiceV2.saveRule(rule).success(function (data) {
                if (data.code == 0) {
                    getMachineRules();
                    if (edit) {
                        gatewayFlowRuleDialog.close();
        ...
        function deleteRule(rule) {
            GatewayFlowServiceV2.deleteRule(rule).success(function (data) {
                if (data.code == 0) {
                    getMachineRules();
                    confirmDialog.close();
                } else {
